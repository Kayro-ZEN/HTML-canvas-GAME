...
export class Background {
  constructor(game) {
    ...
    this.layer10 = new Layer(this.game, this.width, this.height, 0.4, this.layer10image);
    this.layer11 = new Layer(this.game, this.width, this.height, 0.6, this.layer11image);
